...
BOOST_AUTO_TEST_CASE(test_string_formatting)
{
   ...
   BOOST_TEST(value.as_string(0) == "1");
   BOOST_TEST(value.as_string(4) == "1.0000");
   BOOST_TEST(value.as_string(10) == "1.0000000000");
   BOOST_TEST(value.as_string(15) == "1.000000000000000");
}
